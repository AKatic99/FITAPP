<template class="home">
    <div id="home" class="main" >
         <div class="button">
    <a class="btn btn-primary " href="/projekti/fsre_rwa/2020/g7/dodajVjezbu" v-if="userIsAdmin" id="dodaj" role="button"> DODAJ NOVI POST</a>   
        </div>
        <div class="photos">
            <ul class="display">
                <li v-for="post in posts" :key="post.id">
                   <span> <a href= "#">
                    ...
                    <p>{{post.tekst}}</p>
                     <a :id="'post_' + post.id" href="`/projekti/fsre_rwa/2020/g7/viewPost/${post.id}`" target="_blank">Detaljnije</a>
        ...
        methods: {
         ...
         mounted() {
            ...
            if (this.user.role > 0) {
                ...
                this.userIsAdmin = 1;
                setTimeout( () => {
                  document.getElementById("dodaj").href=`/projekti/fsre_rwa/2020/g7/dodajVjezbu`;
                }, 0);
            }
            ...
            axios.get('/projekti/fsre_rwa/2020/g7/api/getPosts').then((res) => {
                this.posts = res.data;
