    ...
    <div>
        <div class="form"> 
            <form class="login-form" >
                ...
                <br />
                <p id="naslov">Naziv</p>
                <p class="t" id="tekst">Kratki opis</p>
                <p class="box">Detaljnije <br /><br /> <span id="more_info"></span></p>
                <div class="mar">
                 
   
                  <a id="editIt"><span>Edit post </span></a>
...
export default {
    ...
    methods: {
      ...
      deletePost(){
        axios.post(`/projekti/fsre_rwa/2020/g7/api/deletePost/${this.info[0].id}`).then( (res) => {
    ...
    mounted() {
        ...
        axios.get(`/projekti/fsre_rwa/2020/g7/api/user`).then( (res) => {
            ...
            if (this.user.role > 0) {
                ...
                this.userIsAdmin = 1;
                setTimeout( () => {
                  document.getElementById("editIt").href=`/projekti/fsre_rwa/2020/g7/edit/${postId}`;
                }, 0);
            }
